                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="name" id="name" class="form-control summernote" required>{{ $special->name ?? old('name') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="post_id" name="post_id" >                                                
                                                ...
                                                <option value="{{ $special?->post?->id }}" selected>{{ $special?->post?->title }}</option>                                                                                                
                                            </select>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-6"></div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="status" name="is_active" >
                                            <option value="1" {{ $special->is_active == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ $special->is_active == 0 ? 'selected' : '' }}>Inactive</option>                                            
                                        </select>
                                    </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#special-form').submit(function (e) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ route('special.update', ['special'=>$special]) }}",
                        data: formData,
                        dataType: 'json',
                        contentType: false,
                        processData: false,                         
