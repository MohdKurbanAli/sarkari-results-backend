                        ...
                        <div class="row">  
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control summernote" name="description" id="ckeditor1" cols="" rows="10">{{ $post->description ?? old('description') ?? '' }}</textarea>                                    
                            ...
                            <div class="col-md-6 col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="organisation_name" name="organisation_name" class="form-control" value="{{ $post->organisation_name ?? old('organisation_name') }}">
                            ...
                            <div class="col-md-6 col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="total_vacancies" name="total_vacancies" class="form-control" value="{{ $post->total_vacancies ?? old('total_vacancies') ?? '' }}">
                            ...
                            <div class="col-md-6 col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="application_mode" name="application_mode">                                        
                                        <option value="0" {{ $post->application_mode == 0 ? 'selected' : '' }}>Online</option>
                                        <option value="1" {{ $post->application_mode == 1 ? 'selected' : '' }}>Offline</option>
                                        <option value="2" {{ $post->application_mode == 2 ? 'selected' : '' }}>Online & Offline Both</option>
                                    </select>
                            ...
                            <div class="col-md-6 col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="job_location" name="job_location" class="form-control" value="{{ $post->job_location ?? old('job_location') ?? '' }}">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control summernote" name="important_dates" id="important_dates" cols="" rows="8">{{ $post->important_dates ?? old('important_dates') ?? '' }}</textarea>                                    
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control summernote" name="application_fee_points" id="application_fee_points" cols="" rows="8">{{ $post->application_fee_points ?? old('application_fee_points') ?? '' }}</textarea>                                    
                            ...
                            <div class="col-md-6 col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="age_header" name="age_header" class="form-control" value="{{ $post->age_header ?? old('age_header') ?? '' }}">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control summernote" name="age_points" id="age_points" cols="" rows="8">{{ $post->age_points ?? old('age_points') ?? '' }}</textarea>                                    
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control summernote" name="job_post_datails" id="job_post_datails" cols="" rows="15">{{ $post->job_post_datails ?? old('job_post_datails') ?? '' }}</textarea>                                    
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control summernote" name="job_post_useful_links" id="job_post_useful_links" cols="" rows="15">{{ $post->job_post_useful_links ?? old('job_post_useful_links') ?? '' }}</textarea>                                    
                            ...
                            <div id="faq-container">
                                @php
                                    $faqnum = 1;   
                                @endphp
                                @if($post->job_post_faq != null)
                                    @foreach ($post?->job_post_faq as $faq)                                                               
                                        <div class="faq-item">
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    <label class="form-label">Question</label>
                                                    <input type="text" id="faq[][question]" name="faq[{{ $faqnum }}][question]" class="form-control" value="{{ $faq->question }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Answer</label>
                                                    <textarea class="form-control summernote-tiny" name="faq[{{ $faqnum }}][answer]" id="faq[][answer]" cols="" rows="2">{{ $faq->question }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                            ...
                            <div class="col-md-6 col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="is_active" name="is_active">                                        
                                        <option value="0" {{ $post->is_active == 0 ? 'selected' : '' }}>Not Published</option>
                                        <option value="1" {{ $post->is_active == 1 ? 'selected' : '' }}>Drafted</option>
                                        <option value="2" {{ $post->is_active == 2 ? 'selected' : '' }}>Published</option>
                                    </select>
                                </div>
                            </div>
...
@section('page_jsk')
    ...
    <script>
        ...
        const existingImages = "{{ $post->job_image }}".split(',').map(filePath => filePath.trim());    
        existingImages.forEach((filePath) => {
            if (filePath) {
                const correctFilePath = window.location.origin + '/' + filePath.replace("/{category}/{post}", "");
        ...
        document.getElementById('add-question-btn').addEventListener('click', function () {
            let faqnum = "{{ $faqnum }}"; // Blade variable
            ...
            const newFaqItem = `
                <div class="faq-item">
                    <div class="col-md-6 col-xl-6">
                        <div class="mb-3">
                            <label class="form-label">Question</label>
                            <input type="text" id="faq[${faqnum}][question]" name="faq[${faqnum}][question]" class="form-control" value="">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label class="form-label">Answer</label>
                            <textarea class="form-control summernote-tiny" name="faq[${faqnum}][answer]" id="faq[${faqnum}][answer]" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <button type="button" class="btn btn-danger btn-sm delete-btn">Delete</button>
            ...
            const addedItem = faqContainer.lastElementChild;
            const deleteButton = addedItem.querySelector('.delete-btn');

            deleteButton.addEventListener('click', function () {
                faqContainer.removeChild(addedItem);
            });
        ...
        $(document).ready(function () {
            ...
            $('#app-form').submit(function (e) {
                ...
                files.forEach(function(fileItem, index) {
                    formData.append('job_image[]', fileItem.file);
                });

                $('#submitbtn').text('Saving...');
                $.ajax({
                    type: "post",
                    url: "{{ route('post.savepost', ['post'=>$post, 'category'=>$category]) }}",
                    data: formData,                    
                    contentType: false,
                    processData: false,                         
